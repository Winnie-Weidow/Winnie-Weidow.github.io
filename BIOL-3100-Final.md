...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-3-2.png)<!-- -->

```
## `stat_bin()` using `bins = 30`. Pick better value with `binwidth`.
```

![](BIOL-3100-Final_files/figure-html/unnamed-chunk-3-3.png)<!-- -->

```
## `stat_bin()` using `bins = 30`. Pick better value with `binwidth`.
```

![](BIOL-3100-Final_files/figure-html/unnamed-chunk-3-4.png)<!-- -->
...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-5-1.png)<!-- -->

```
## `geom_smooth()` using formula = 'y ~ x'
```

![](BIOL-3100-Final_files/figure-html/unnamed-chunk-5-2.png)<!-- -->
...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](BIOL-3100-Final_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
